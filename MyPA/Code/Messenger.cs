...
{
    /// <summary>
    /// From https://github.com/Yeah69/MessengerPattern/blob/master/Messenger.cs
    /// ----------------------------------------------------------------------------
    ...
    /// Improvement: I made the the MessageKey sensitive to the message type. 
    /// Thus, several different message types with no context object can be registered to the same receiver object.
    /// </summary>
    public class Messenger
    {
        ...
        /// The action parameter will be executed when a corresponding message is sent.
        /// </summary>
